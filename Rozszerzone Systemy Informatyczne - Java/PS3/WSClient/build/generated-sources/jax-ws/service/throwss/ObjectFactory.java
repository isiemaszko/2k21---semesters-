 ...
 * generated in the service.throwss package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetShopInfo_QNAME = new QName("http://throwss.service/", "getShopInfo");
    private final static QName _InvalidInputException_QNAME = new QName("http://throwss.service/", "InvalidInputException");
    private final static QName _GetShopInfoResponse_QNAME = new QName("http://throwss.service/", "getShopInfoResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: service.throwss
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://throwss.service/", name = "getShopInfo")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://throwss.service/", name = "InvalidInputException")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://throwss.service/", name = "getShopInfoResponse")
