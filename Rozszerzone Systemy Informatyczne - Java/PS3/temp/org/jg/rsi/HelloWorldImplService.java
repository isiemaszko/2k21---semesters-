 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://rsi.jg.org/", wsdlLocation = "http://localhost:9805/ws/hello?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:9805/ws/hello?wsdl");
