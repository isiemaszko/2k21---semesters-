 ...
 * generated in the com.is.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetServerName_QNAME = new QName("http://ws.is.com/", "getServerName");
    private final static QName _GetServerNameResponse_QNAME = new QName("http://ws.is.com/", "getServerNameResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.is.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.is.com/", name = "getServerName")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.is.com/", name = "getServerNameResponse")
